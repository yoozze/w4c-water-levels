...
def get_weather_data(archive, station, from_date=None, to_date=None, reindex=True):
    ...
    df = pd.read_sql_query(f'''SELECT w.* 
                               FROM weather w
...
def get_sw_weather_data(station, from_date=None, to_date=None, reindex=True):
    ...
    """
    return get_weather_data('surface', station, from_date, to_date, reindex)


def get_gw_weather_data(station, from_date=None, to_date=None, reindex=True):
    ...
    """
    return get_weather_data('ground', station, from_date, to_date, reindex)
